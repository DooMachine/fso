...
export enum InterestActionTypes {
    GET_INTERESTS = '[ExploreInterest] GET_INTERESTS',
    GET_INTERESTS_SUCCESS = '[ExploreInterest] GET_INTERESTS_SUCCESS',
    GET_INTERESTS_FAIL = '[ExploreInterest] GET_INTERESTS_FAIL',
    FOLLOW_INTERESTS = '[ExploreInterest] FOLLOW_INTERESTS',
    FOLLOW_INTERESTS_SUCCESS = '[ExploreInterest] FOLLOW_INTERESTS_SUCCESS',
    FOLLOW_INTERESTS_FAIL = '[ExploreInterest] FOLLOW_INTERESTS_FAIL',
    UNFOLLOW_INTERESTS = '[ExploreInterest] UNFOLLOW_INTERESTS',
    UNFOLLOW_INTERESTS_SUCCESS = '[ExploreInterest] UNFOLLOW_INTERESTS_SUCCESS',
    UNFOLLOW_INTERESTS_FAIL = '[ExploreInterest] UNFOLLOW_INTERESTS_FAIL',
}
