...
@Component({
  selector: 'app-editpost-postdetail',
  templateUrl: './editpost-postdetail.component.html',
  styleUrls: ['./editpost-postdetail.component.scss']
})
export class EditPostPostdetailComponent implements OnInit {
  ...
  @Input() set prevSelectedCollectionId(id:number){
    this.form.patchValue({selectedCollectionId:id});
  };
  @Input()
