...
@Injectable()
export class TrendingInterestService {
    ...
    public GetTredingInterests = (langCode: string ="WW" , pageIndex: number, pageSize: number, order: string): Observable<any> => {
        return this._http.get<any>
        (this.actionUrl + `GetTrendingInterests?langCode=${langCode}&pageIndex=${pageIndex}&pageSize=${pageSize}&order=${order}`,
