...
export enum PostActionTypes {
    GET_POSTS = '[User Posts] GET_POSTS',
    GET_POSTS_SUCCESS = '[User Posts] GET_POSTS_SUCCESS',
    GET_POSTS_FAIL = '[User Posts] GET_POSTS_FAIL',

    LIKE_POST = '[User Posts] LIKE_POST',
    LIKE_POST_SUCCESS = '[User Posts] LIKE_POST_SUCCESS',
    LIKE_POST_FAIL = '[User Posts] LIKE_POST_FAIL',

    UNLIKE_POST = '[User Posts] UNLIKE_POST',
    UNLIKE_POST_SUCCESS = '[User Posts] UNLIKE_POST_SUCCESS',
    UNLIKE_POST_FAIL = '[User Posts] UNLIKE_POST_FAIL',
}
