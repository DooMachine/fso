...
export const initialState: State = adapter.getInitialState({
  ...
  export function reducer(state = initialState, action): State {
    switch (action.type) {
      case userActivityActions.UserActivityActionTypes.GET_USER_ACTIVITIES:
        return {
          ...state,
          isLoading: true,
          pageIndex: state.pageIndex +1,
        };
      case userActivityActions.UserActivityActionTypes.GET_USER_ACTIVITIES_SUCCESS:
        ...
        case userActivityActions.UserActivityActionTypes.GET_USER_ACTIVITIES_FAIL:
          return {
            ...state,
            isLoading: false,
          };
      case userActivityActions.UserActivityActionTypes.LIKE_POST:
        let original;
      ...
      case userActivityActions.UserActivityActionTypes.LIKE_POST_SUCCESS:
        let perevsPost;
      ...
      case userActivityActions.UserActivityActionTypes.LIKE_POST_FAIL:
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_POST:{
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_POST_SUCCESS:{
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_POST_FAIL:{
      ...
      case userActivityActions.UserActivityActionTypes.LIKE_REVIEW:{
      ...
      case userActivityActions.UserActivityActionTypes.LIKE_REVIEW_SUCCESS:{
      ...
      case userActivityActions.UserActivityActionTypes.LIKE_REVIEW_FAIL:{
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_REVIEW:{
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_REVIEW_SUCCESS:{
      ...
      case userActivityActions.UserActivityActionTypes.UNLIKE_REVIEW_FAIL:{
      ...
      case userActivityActions.UserActivityActionTypes.DISLIKE_REVIEW:{
      ...
      case userActivityActions.UserActivityActionTypes.DISLIKE_REVIEW_SUCCESS:{
      ...
      case userActivityActions.UserActivityActionTypes.DISLIKE_REVIEW_FAIL:{
      ...
      case userActivityActions.UserActivityActionTypes.UNDISLIKE_REVIEW:{
      ...
      case userActivityActions.UserActivityActionTypes.UNDISLIKE_REVIEW_SUCCESS:{
  ...
  export const getActivityState = createSelector(getProfileState, state => state.activity);
