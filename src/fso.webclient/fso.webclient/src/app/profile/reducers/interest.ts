...
export const initialState: State = adapter.getInitialState({
      ...
      case fromInterestActions.InterestActionTypes.FOLLOW_INTERESTS_FAIL:
        ...
        case fromInterestActions.InterestActionTypes.UNFOLLOW_INTERESTS_FAIL:
          return adapter.updateOne({id: action.payload.id,
            changes: {  isCurrentUserFollowing: action.payload.followState === 0 }},
            state);
      case fromInterestActions.InterestActionTypes.OPEN_INTERESTS_MODAL:
        return{
          ...state,
          isLoading: true,
          listModalOpen: true
        };
      case fromInterestActions.InterestActionTypes.CLOSE_INTERESTS_MODAL:
        return{
          ...state,
          isLoading: true,
          listModalOpen: false
  ...
  export const getInterestState = createSelector(getProfileState, state => state['interests']);
