...
export class UserInterestService {
    ...
    public GetUserInterests = (userName: string, pageIndex: number, pageSize: number, order: string): Observable<any> => {
        return this._http.get<any>
        (this.actionUrl + `GetUserInterests?userName=${userName}&pageIndex=${pageIndex}&pageSize=${pageSize}&order=${order}`,
