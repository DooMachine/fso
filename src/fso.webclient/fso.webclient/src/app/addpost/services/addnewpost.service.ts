...
export class AddNewPostService {
    ...
    public GetUserUnpublishedPost = (): Observable<any> => {
        return this._http.get<any>(this.actionUrl+`GetPublishingPost`, { headers: this.headers});             
    }
    ...
    public PublishPost = (formValues: any): Observable<any> => {
        const body: any =  formValues ;
        return this._http.post<any>(this.actionUrl + `PublishPost`,
             JSON.stringify(body), { headers: this.headers});
    }
}
