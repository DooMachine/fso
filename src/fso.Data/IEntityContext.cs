...
namespace fso.Data
{
    public interface IEntityContext : IDisposable
    {
        ...
        EntityEntry GetDbEntityEntrySafely<TEntity>(TEntity entity) where TEntity : BaseEntity;
        EntityEntry GetChildDbEntityEntrySafely<TEntity>(TEntity entity) where TEntity : class;
    }
}
