...
using fso.IdentityProvider.Models;
using fso.IdentityProvider.Models.ManageViewModels;
using fso.IdentityProvider.Services;
using fso.IdentityData.Domains;

namespace fso.IdentityProvider.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ManageLogins(ManageMessageId? message = null)
        {
            ...
            var otherLogins = scheme.Where(auth => userLogins.All(ul => auth.Name != ul.LoginProvider)).ToList();
